...
// @Param	order	query	string	false	"Announcement corresponding to each sortby field, if single value, apply to all sortby fields. e.g. desc,asc ..."
// @Param	limit	query	string	false	"Limit the size of result set. Must be an integer"
// @Param	offset	query	string	false	"Start position of result set. Must be an integer"
// @Success 200 {object} models.Announcement
// @Failure 403
// @router /count [get]
func (c *AnnouncementController) GetAllCount() {
	var fields []string
	var sortby []string
	var order []string
	...
	count, err := models.GetAllAnnouncementCount(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = models.GetReturnData(-1, err.Error(), nil)
	} else {
